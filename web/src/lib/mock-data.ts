export const projects = [
  {
    ...
    description: "No-till farming and cover crops to increase soil carbon sequestration on 5,000 acres of farmland in central Iowa.",
    location: "Iowa, USA",
    carbonCredits: 5000,
    price: 25,
  ...
  },
  {
    ...
    description: "Protection and restoration of 10,000 hectares of tropical rainforest.",
    location: "Thailand",
    carbonCredits: 8000,
    price: 30,
...
const generatePriceHistory = (basePrice: number, volatility = 0.1) => {
  ...
  for (let i = 30; i >= 0; i--) {
    ...
    currentPrice = Math.max(basePrice * 0.7, Math.min(basePrice * 1.3, currentPrice + randomChange));
