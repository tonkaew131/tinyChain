...
const projectFormSchema = z.object({
  ...
  practices: z.string().min(20, {
    message: "Sustainable practices description must be at least 20 characters.",
  }),
  benefits: z.string().min(20, {
    message: "Environmental benefits description must be at least 20 characters.",
  }),
  verification: z.string().min(20, {
    message: "Verification process description must be at least 20 characters.",
  }),
})
        ...
        <Tabs defaultValue="basic" className="w-full">
          ...
          <TabsContent value="basic" className="space-y-6">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="e.g., Regenerative Agriculture in Iowa" {...field} />
                  </FormControl>
                  <FormDescription>A clear, descriptive title for your carbon reduction project.</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Provide a comprehensive description of your carbon reduction project.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>Where is your project located?</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>When did/will the project start?</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>When is the project expected to end?</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Expected Carbon Credits (tons CO₂e)</FormLabel>
                    <FormControl>
                      <Input type="number" min="1" {...field} />
                    </FormControl>
                    <FormDescription>Estimated total carbon credits to be generated.</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>Your asking price per ton of CO₂e.</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
          ...
          <TabsContent value="details" className="space-y-6">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Detail the specific practices you're implementing to reduce carbon emissions.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Environmental Benefits</FormLabel>
                  <FormControl>
                    <Textarea
                  ...
                  <FormDescription>Explain the positive environmental impacts beyond carbon reduction.</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
                ...
                <FormItem>
                  ...
                  <Select onValueChange={field.onChange} defaultValue={field.value}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="vm0026">VM0026: Methodology for Sustainable Grassland Management</SelectItem>
                  ...
                  <FormDescription>The carbon accounting methodology used for your project.</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>The certification standard you're using or planning to use.</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>Explain the verification process for your carbon credits.</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
          ...
          <TabsContent value="media" className="space-y-6">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Upload images that showcase your project. High-quality images help attract buyers.
              </p>
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Upload relevant project documentation, such as methodology details, verification reports, etc.
              </p>
              <Separator className="my-4" />
